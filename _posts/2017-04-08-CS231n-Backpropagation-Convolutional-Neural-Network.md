...
<img src="/images/spatial_positions_dashed.png" width="200">

where, $y_{21}$, for instance, corresponds to the application of the first filter at the spatial position defined by the dashed green square.
